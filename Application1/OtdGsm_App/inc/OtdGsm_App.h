...
#define GSM_INIT_MAX_COMMAND 12U//10U //number of AT commands used for GSM initialisation, value should be changed if more AT commands added
#define TCP_INIT_MAX_COMMAND 14U//12U
#define TCP_SEND_MAX_COMMAND 19U//16U

#define SERVER_IP_ADDRESS 	"122.166.210.142"
#define SERVER_PORT		"9090"//"8050"
